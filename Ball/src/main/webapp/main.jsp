<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" session="true" %>
    <%@ page import="dto.User, dao.MatchDAO, dto.Match, java.util.*, java.time.*" %>
        ...
        <% // 로그인 체크 Object obj=session.getAttribute("loginUser"); if (obj==null) { response.sendRedirect("index.jsp");
            return; } User loginUser=(obj instanceof User) ? (User) obj : null; String displayName=(loginUser !=null &&
            loginUser.getName() !=null) ? loginUser.getName() : String.valueOf(obj); String
            ctx=request.getContextPath(); // 오늘 날짜 LocalDate today=LocalDate.now(); // DB에서 오늘 경기 불러오기 MatchDAO mdao=new
            MatchDAO(); List<Match> matches = mdao.getTodayMatches();
            %>
                    ...
                    <div class="container px-4 px-lg-5">
                        ...
                        <div class="hero-section row">
                            <div class="col-lg-5 hero-text">
                                ...
                                <a href="<%=ctx%>/sports.jsp" class="btn btn-light btn-lg fw-bold text-success">지금
                                    참여하기</a>
                            </div>
...
>>>>>>> bcb40cd887d2e5d6679132ca68ef94c71ba54a46
                                        ...
                                        <div class="list-group-item d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <small class="text-muted">
                                                    <%=m.getLocation()%> | 인원: <%=m.getCurrentPlayers()%> /
                                                            <%=m.getMaxPlayers()%>
                                                </small>
                                            </div>
                                            <span class="badge bg-success rounded-pill px-3 py-2">예약중</span>
