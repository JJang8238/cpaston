<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" session="true" %>
    <%@ page import="dto.User, dao.PostDAO, dto.Post, dao.PlaceReviewDAO, dao.MatchReviewDAO, java.util.*" %>
        ...
        <% Object loginObj=session.getAttribute("loginUser"); if (loginObj==null) { response.sendRedirect("index.jsp");
            return; } User loginUser=(User) loginObj; String displayName=(loginUser.getName() !=null &&
            !loginUser.getName().isEmpty()) ? loginUser.getName() : loginUser.getUsername(); int
            loginUserId=loginUser.getId(); String ctx=request.getContextPath(); String
            fUsername=loginUser.getUsername(); String fName=displayName; String fEmail=loginUser.getEmail(); String
            fRole=loginUser.getRole(); /* 🔥 핵심 수정: 업로드된 이미지 있으면 그대로 사용 */ String fProfile=(loginUser.getProfileImage()
            !=null && !loginUser.getProfileImage().isEmpty()) ? loginUser.getProfileImage() : ctx + "/assets/img/1.png"
                                ...
                                <div class="container px-5">
                                    ...
                                    <div class="collapse navbar-collapse" id="nav">
                                        <ul class="navbar-nav ms-auto">
                                            ...
                                            <li class="nav-item"><a class="nav-link" href="<%=ctx%>/logout.jsp">로그아웃</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-8">
                                            <div class="card shadow-sm">
                                                <div class="card-body">
                                                    ...
                                                    <div class="mb-2"><span class="text-muted">아이디</span>
                                                        <div class="fw-semibold">
                                                            <%=fUsername%>
                                                        </div>
                                                    </div>
                                                    <div class="mb-2"><span class="text-muted">이름</span>
                                                        <div class="fw-semibold">
                                                            <%=fName%>
                                                        </div>
                                                    </div>
                                                    <div class="mb-2"><span class="text-muted">이메일</span>
                                                        <div class="fw-semibold">
                                                            <%=fEmail%>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="d-flex gap-2 mt-4">
                                                        <a href="<%=ctx%>/editProfile.jsp" class="btn btn-primary">프로필
                                                            수정</a>
                                                        <a href="<%=ctx%>/main.jsp"
                                                        ...
                                                        <ul class="list-group mb-3">
                                                            <% for (var r : myPlaceReviews) { %>
                                                                <li class="list-group-item">
                                                                    ...
                                                                    <span class="text-muted small">(<%=r.get("rating")%>
                                                                            )</span><br>
