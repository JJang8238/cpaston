            ...
            <div class="form-card">
              ...
              <div class="mb-1">
                ...
                <div class="input-group">
                  ...
                  <button class="btn btn-primary" id="btnVerifyCode" type="button" onclick="verifyEmailCode()">코드
                    확인</button>
                </div>
              </div>
            </div>
              ...
              <form action="<%=ctx%>/register" method="post" onsubmit="return validateBeforeSubmit();">
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    ...
                    <button class="btn btn-outline-secondary" id="btnCheckDup" type="button" disabled
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    <input type="password" class="form-control" id="password" name="password" disabled minlength="8"
                      maxlength="20" placeholder="8~20자, 영문/숫자/특수문자 2종 이상">
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    <input type="password" class="form-control" id="passwordConfirm" disabled minlength="8"
